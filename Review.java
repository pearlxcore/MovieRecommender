...
public class Review {
    public void showPopUp() {
        ...
        if (buttonClicked == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(null, "Thank you for your cooperation !", "REVIEW", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "Thank you for your review !", "REVIEW", JOptionPane.INFORMATION_MESSAGE);
        }
